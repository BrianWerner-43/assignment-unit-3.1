...
let favoriteFoods = ['Tacos', 'Sushi', 'Pizza'];
...
let reversedGems = gems;
reversedGems.sort();
reversedGems.reverse();
...
console.log('Our new gem array is:', gemString);
...
console.log('Combined arrays is:', colorfulGems);
